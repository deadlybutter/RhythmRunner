...
var level = [
   ...
   {time:0,     event:"obstacle_pattern",     value:"A1"},
   ...
   {time:12,    event:"end_segment"},
    ...
    {time:1,     event:"obstacle_pattern",     value:"A1"},
    ...
    {time:2,     event:"obstacle_pattern",     value:"A1"},
   ...
   {time:4,     event:"obstacle_pattern",     value:"A1"},
